            ...
            <div class="carousel owl-carousel gap-small" data-margin="0" data-dots="true" data-autoplay="false" data-autoplay-timeout="5000" data-responsive='{"0":{"items": "1"}, "768":{"items": "2"}, "992":{"items": "3"}, "1400":{"items": "4"}}'>
                <div class="item">
                    <div class="item-inner">
                        <div class="card">
                            <div class="card-body">
                                <img class="rounded-circle w-15 mb-4" src="assets/img/avatars/te1.jpg" alt="" />
                ...
                <div class="item">
                    <div class="item-inner">
                        <div class="card">
                            <div class="card-body">
                                <img class="rounded-circle w-15 mb-4" src="assets/img/avatars/te2.jpg"  alt="" />
                ...
                <div class="item">
                    <div class="item-inner">
                        <div class="card">
                            <div class="card-body">
                                <img class="rounded-circle w-15 mb-4" src="assets/img/avatars/te3.jpg"  alt="" />
                ...
                <div class="item">
                    <div class="item-inner">
                        <div class="card">
                            <div class="card-body">
                                <img class="rounded-circle w-15 mb-4" src="assets/img/avatars/te4.jpg"  alt="" />
                ...
                <div class="item">
                    <div class="item-inner">
                        <div class="card">
                            <div class="card-body">
                                <img class="rounded-circle w-15 mb-4" src="assets/img/avatars/te5.jpg"  alt="" />
                ...
                <div class="item">
                    <div class="item-inner">
                        <div class="card">
                            <div class="card-body">
                                <img class="rounded-circle w-15 mb-4" src="assets/img/avatars/te6.jpg"  alt="" />
    ...
    <div class="container pt-18 pb-14 pt-md-19 pb-md-16">
        <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center">
            <div class="col-md-8 col-lg-6 offset-lg-0 col-xl-5 offset-xl-1 position-relative">
                ...
                <figure class="rounded"><img src="assets/img/photos/about4.jpg"  alt=""></figure>
            </div>
            <!--/column -->
            <div class="col-lg-6">
