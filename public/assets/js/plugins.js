!function (t, e) {
    ...
    return i = {
        686: function (t, e, i) {
            ...
            var e = i(279), a = i.n(e), e = i(370), l = i.n(e), e = i(817), r = i.n(e);
            ...
            var s = function () {
                ...
                return i = [{
                    ...
                    key: "onClick", value: function (t) {
                        var e = t.delegateTarget || t.currentTarget, t = function () {
                            var t = void 0 === (i = (s = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).action) ? "copy" : i,
                                e = s.container, i = s.target, s = s.text;
                            ...
                            return s ? u(s, {container: e}) : i ? "cut" === t ? c(i) : u(i, {container: e}) : void 0
                        }({
    ...
    return (() => {
        ...
        const e = (t, e = {}) => {
            ...
            const {duration: n = 1e3, delay: i = 16} = e, o = n / i,
                r = t.toString().split(/(<[^>]+>|[0-9.][,.0-9]*[0-9]*)/), a = [];
            for (let t = 0; t < o; t++) a.push("");
            for (let e = 0; e < r.length; e++) if (/([0-9.][,.0-9]*[0-9]*)/.test(r[e]) && !/<[^>]+>/.test(r[e])) {
                let i = r[e];
    ...
    var s = Math.pow, n = Math.sqrt, o = Math.sin, r = Math.cos, a = Math.PI, l = 1.70158, h = 1.525 * l, c = 2 * a / 3,
        u = 2 * a / 4.5;
    e.extend(e.easing, {
        def: "easeOutQuad", swing: function (t) {
            ...
            return 1 - i(1 - t)
        }, easeOutBounce: i, easeInOutBounce: function (t) {
    ...
    function h(t) {
        var i = {}, s = !0, e = 0, n = arguments.length;
    ...
    function d(t, e) {
        if (0 != m(t = !o(t = q(t) || t === window || t === document ? [t] : t) && !u(t) ? [t] : t)) if (o(t) && !u(t)) for (var i = t.length, s = 0; s < i && !1 !== e.call(t[s], t[s], s, t); s++) ; else if (u(t)) for (var n in t) if (w(t, n) && !1 === e.call(t[n], t[n], n, t)) break
    }

    function p(t, e, i) {
        var s = 1 < arguments.length && void 0 !== e ? e : null, n = 2 < arguments.length && void 0 !== i ? i : null,
            t = t[a] = t[a] || [], o = {all: t, evt: null, found: null};
    ...
    function P(i, t, e) {
        var s = 1 < arguments.length && void 0 !== t ? t : {}, n = s.onElement, o = s.withCallback,
            t = s.avoidDuplicate, r = void 0 === t || t, t = s.once, a = void 0 !== t && t, s = s.useCapture,
            l = void 0 !== s && s, h = 2 < arguments.length ? e : void 0, c = n || [];
    ...
    function N(e, t, i) {
        var s, t = 1 < arguments.length && void 0 !== t ? t : "", n = 2 < arguments.length && void 0 !== i && i;
    ...
    function i(t, e, i) {
        if (W(t)) console.error("Inject assets error"); else if (H(e) && (i = e, e = !1), y(e) && e in window) H(i) && i(); else {
            if (-1 !== t.indexOf(".css")) {
                if ((r = document.querySelectorAll('link[href="' + t + '"]')) && 0 < r.length) return void (H(i) && i());
                var s = document.getElementsByTagName("head")[0], n = s.querySelectorAll('link[rel="stylesheet"]'),
    ...
    function x(t, e) {
        var i, s, n,
            n = (s = e, 0 == (n = g(i = t) * g(s)) ? 0 : (1 < (n = (i.x * s.x + i.y * s.y) / n) && (n = 1), Math.acos(n)));
    ...
    var Y = (t(k, [{
        ...
        key: "_swipeDirection", value: function (t, e, i, s) {
    ...
    function V(t) {
        var e = function () {
            ...
            s = z(t, "gslide-media") ? t : t.querySelector(".gslide-media"), n = j(s, ".ginner-container"),
    ...
    var E = (t($, [{
        ...
        key: "drag", value: function (t) {
            if (this.active) {
                ...
                var e = Math.abs(this.currentX), i = Math.abs(this.currentY);
    ...
    function $() {
        ...
        r(this, $);
        var i = t.dragEl, s = t.toleranceX, n = void 0 === s ? 40 : s, o = t.toleranceY, s = void 0 === o ? 65 : o,
            o = t.slide, o = void 0 === o ? null : o, t = t.instance, t = void 0 === t ? null : t;
    ...
    function M(r, a, l, h) {
        var c = this, t = r.querySelector(".ginner-container"), u = "gvideo" + l, e = r.querySelector(".gslide-media"),
        ...
        var m = a.href, g = (location.protocol.replace(":", ""), ""), f = "", y = !1;
        e.style.maxWidth = a.width, i(this.settings.plyr.js, "Plyr", function () {
            ...
            if (m.match(/vimeo\.com\/([0-9]*)/) && (t = /vimeo.*\/(\d+)/i.exec(m), g = "vimeo", f = t[1]), (m.match(/(youtube\.com|youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/) || m.match(/youtu\.be\/([a-zA-Z0-9\-_]+)/) || m.match(/(youtube\.com|youtube-nocookie\.com)\/embed\/([a-zA-Z0-9\-_]+)/)) && (t = function (t) {
                ...
                var i, s, n = m.toLowerCase().split(".").pop(), o = {mp4: "", ogg: "", webm: ""};
    ...
    function X(t, e, i, s) {
        var n, o, r, a = t.querySelector(".gslide-media"), n = (n = {
            url: e.href,
            callback: s
    ...
    var U = (t(Q, [{
        ...
        key: "parseConfig", value: function (s, n) {
            var o = this, r = h({descPosition: n.descPosition}, this.defaults);
            if (u(s) && !q(s)) {
                w(s, "type") || (w(s, "content") && s.content ? s.type = "inline" : w(s, "href") && (s.type = this.sourceType(s.href)));
                var t = h(r, s);
                return this.setSize(t, n), t
            }
            var a, e, i = "", l = s.getAttribute("data-glightbox"), t = s.nodeName.toLowerCase();
            if ("a" === t && (i = s.href), "img" === t && (i = s.src, r.alt = s.alt), r.href = i, d(r, function (t, e) {
                ...
                var i = l, s = new RegExp("s?" + e + "s?:s?(.*?)(" + a + "s?:|$)"), s = i.match(s);
    ...
    var G = (t(Z, [{
        key: "setContent", value: function () {
            var e = this, i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null,
                t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1];
            if (z(i, "loaded")) return !1;
            var s = this.instance.settings, n = this.slideConfig, o = f();
            H(s.beforeSlideLoad) && s.beforeSlideLoad({index: this.index, slide: i, player: !1});
            var r, a = n.type, l = n.descPosition, h = i.querySelector(".gslide-media"),
                c = i.querySelector(".gslide-title"), u = i.querySelector(".gslide-desc"),
                d = i.querySelector(".gdesc-inner"), p = t, m = "gSlideTitle_" + this.index,
            ...
            if (H(s.afterSlideLoad) && (p = function () {
                ...
                if ("external" !== a) return "inline" === a ? (function (t, e, i, s) {
                    var n, o = this, r = t.querySelector(".gslide-media"),
        ...
        key: "descriptionEvents", value: function (t, o) {
            var r = this, t = t.querySelector(".desc-more");
            if (!t) return !1;
            P("click", {
                onElement: t, withCallback: function (t, e) {
                    t.preventDefault();
                    var i = document.body, s = j(e, ".gslide-desc");
                    if (!s) return !1;
                    s.innerHTML = o.description, O(i, "gdesc-open");
                    var n = P("click", {
                        onElement: [i, j(s, ".gslide-description")], withCallback: function (t, e) {
    ...
    var K = f(),
        ...
        tt = document.getElementsByTagName("html")[0], et = {
            selector: ".glightbox",
            elements: null,
            skin: "clean",
            theme: "clean",
            ...
            key: "open", value: function () {
                ...
                var s, n, o, r, i, a, l, h, c, u, d, p, m, g, f, y, v, b, w, x, S, _, T, k, A, C, E, $, M,
                    I = document.body;
                0 < window.innerWidth - document.documentElement.clientWidth && ((t = document.createElement("style")).type = "text/css", t.className = "gcss-styles", document.head.appendChild(t), O(I, "gscrollbar-fixer")), O(I, "glightbox-open"), O(tt, "glightbox-open"), K && (O(document.body, "glightbox-mobile"), this.settings.slideEffect = "slide", this.settings.autoplayVideos = !1), this.showSlide(e, !0), 1 == this.elements.length ? (O(this.prevButton, "glightbox-button-hidden"), O(this.nextButton, "glightbox-button-hidden")) : (L(this.prevButton, "glightbox-button-hidden"), L(this.nextButton, "glightbox-button-hidden")), this.lightboxOpen = !0, this.trigger("open"), H(this.settings.onOpen) && this.settings.onOpen(), J && this.settings.touchNavigation && ((s = this).events.hasOwnProperty("touch") || (e = F(), n = e.width, o = e.height, h = r = !1, y = f = g = m = l = a = i = null, _ = S = p = d = !(u = c = 1), T = {}, k = {}, C = A = x = w = 0, e = document.getElementById("glightbox-slider"), $ = document.querySelector(".goverlay"), e = new Y(e, {
                    touchStart: function (t) {
                        ...
                        if (r && (k = t.targetTouches[0], !d && !p)) {
                            ...
                            h = !0;
                            var i, e = t.targetTouches[0].clientX, t = t.targetTouches[0].clientY, e = A - e, t = C - t;
                        ...
                        if (r) {
                            ...
                            var t = Math.abs(parseInt(x)), e = Math.abs(parseInt(w));
            ...
            key: "preloadSlide", value: function (t) {
                ...
                if (z(i, "loaded")) return !1;
                var s = this.elements[t], n = s.type, o = {
                    index: t,
                    slide: i,
                    slideNode: i,
                    slideConfig: s.slideConfig,
            ...
            key: "insertSlide", value: function () {
                ...
                var i = new G(t, this, e), s = i.getConfig(), n = h({}, s), o = i.create(), r = this.elements.length - 1;
                ...
                this.slidesContainer && (r < e ? this.slidesContainer.appendChild(o) : (r = this.slidesContainer.querySelectorAll(".gslide")[e], this.slidesContainer.insertBefore(o, r)), (this.settings.preload && 0 == this.index && 0 == e || this.index - 1 == e || this.index + 1 == e) && this.preloadSlide(e), 0 == this.index && 0 == e && (this.index = 1), this.updateNavigationClasses(), t = this.slidesContainer.querySelectorAll(".gslide")[e], i = this.getSlidePlayerInstance(e), n.slideNode = t), this.trigger("slide_inserted", {
                    ...
                    trigger: null,
                    player: i
                }), H(this.settings.slideInserted) && this.settings.slideInserted({index: e, slide: t, player: i})
            }
        }, {
            ...
            key: "slideAnimateIn", value: function (t, e) {
                var i = this, s = t.querySelector(".gslide-media"), n = t.querySelector(".gslide-description"), o = {
            ...
            key: "slideAnimateOut", value: function () {
                ...
                var t = this.settings.slideEffect, t = "none" !== t ? this.settings.cssEfects[t].out : t;
                this.slidePlayerPause(s), this.trigger("slide_before_change", {
                    ...
                    var t = s.querySelector(".ginner-container"), e = s.querySelector(".gslide-media"),
            ...
            key: "getSlidePlayerInstance", value: function (t) {
                var e = "gvideo" + t, t = this.getAllPlayers();
            ...
            key: "setElements", value: function (t) {
                ...
                t && t.length && d(t, function (t, e) {
                    var i = new G(t, n, e), s = i.getConfig(), t = h({}, s);
            ...
            key: "getElements", value: function () {
                ...
                this.elements = this.elements || [], !W(this.settings.elements) && n(this.settings.elements) && this.settings.elements.length && d(this.settings.elements, function (t, e) {
                    var i = new G(t, o, e), s = i.getConfig(), t = h({}, s);
            ...
            key: "build", value: function () {
                ...
                var t = document.body.childNodes, e = [];
                d(t, function (t) {
                ...
                var s = w(this.settings.svg, "next") ? this.settings.svg.next : "",
                    ...
                    o = w(this.settings.svg, "close") ? this.settings.svg.close : "", t = this.settings.lightboxHTML;
            ...
            key: "resize", value: function () {
                var t, e, i, s, n, o, r, a, l,
                    h = (h = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null) || this.activeSlide;
            ...
            key: "trigger", value: function (n) {
                var e = this, o = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : null, r = [];
                d(this.apiEvents, function (t, e) {
                    var i = t.evt, s = t.once, t = t.callback;
                    i == n && (t(o), s && r.push(e))
    ...
    var a = e.jQuery, l = e.console, h = Array.prototype.slice;
    (r.prototype = Object.create(t.prototype)).options = {}, r.prototype.getImages = function () {
        ...
        if (e && c[e]) {
            ...
            if ("string" == typeof this.options.background) for (var o = t.querySelectorAll(this.options.background), s = 0; s < o.length; s++) {
                var r = o[s];
    ...
    var u = Array.prototype.slice, n = t.console, d = void 0 === n ? function () {
    } : function (t) {
        n.error(t)
    };
    ...
    function g(t) {
        if (b || (b = !0, (d = document.createElement("div")).style.width = "200px", d.style.padding = "1px 2px 3px 4px", d.style.borderStyle = "solid", d.style.borderWidth = "1px 2px 3px 4px", d.style.boxSizing = "border-box", (u = document.body || document.documentElement).appendChild(d), c = m(d), f = 200 == Math.round(p(c.width)), g.isBoxSizeOuter = f, u.removeChild(d)), (t = "string" == typeof t ? document.querySelector(t) : t) && "object" == typeof t && t.nodeType) {
            ...
            for (var s = i.isBorderBox = "border-box" == e.boxSizing, n = 0; n < v; n++) {
                var o = y[n], r = e[o], r = parseFloat(r);
                i[o] = isNaN(r) ? 0 : r
            }
            var a = i.paddingLeft + i.paddingRight, l = i.paddingTop + i.paddingBottom,
                ...
                u = i.borderLeftWidth + i.borderRightWidth, d = i.borderTopWidth + i.borderBottomWidth, t = s && f,
                s = p(e.width);
    ...
    var f, e = "undefined" == typeof console ? function () {
        } : function (t) {
            console.error(t)
        },
    ...
    return l.htmlInit = function (r, a) {
        l.docReady(function () {
            var t = l.toDashed(a), s = "data-" + t, e = document.querySelectorAll("[" + s + "]"),
                t = document.querySelectorAll(".js-" + t), t = l.makeArray(e).concat(l.makeArray(t)),
                n = s + "-options", o = i.jQuery;
    ...
    t.constructor = i, t._create = function () {
        ...
        var t = getComputedStyle(this.element), e = this.layout._getOption("originLeft"),
            ...
            o = parseFloat(s), r = parseFloat(n), t = this.layout.size;
        -1 != s.indexOf("%") && (o = o / 100 * t.width), -1 != n.indexOf("%") && (r = r / 100 * t.height), o = isNaN(o) ? 0 : o, r = isNaN(r) ? 0 : r, o -= e ? t.paddingLeft : t.paddingRight, r -= i ? t.paddingTop : t.paddingBottom, this.position.x = o, this.position.y = r
    ...
    var l = t.console, h = t.jQuery, c = 0, u = {};
    ...
    return t._resetLayout = function () {
        ...
        var e = a(t), i = this._getElementOffset(t), s = this._getOption("originLeft") ? i.left : i.right,
    ...
    h.sortDataParsers = {
        ...
        this.options.sortBy && (t = o.makeArray(this.options.sortBy), this._getIsSameSortBy(t) || (this.sortHistory = t.concat(this.sortHistory)), r = this.sortHistory, a = this.options.sortAscending, this.filteredItems.sort(function (t, e) {
            for (var i = 0; i < r.length; i++) {
                var s = r[i], n = t.sortData[s], o = e.sortData[s];
...
class iTooltip {
    ...
    getEdges(t) {
        ...
        return {left: t.clientX, right: e.clientWidth - t.clientX, top: t.clientY, bottom: e.clientHeight - t.clientY}
    }
}
...
!function (a) {
    a.fn.hmbrgr = function (t) {
        function n(t) {
            a(t).data("clickable", !0).find("span").eq(0).css({top: i}), a(t).find("span").eq(1).css({top: r}), a(t).find("span").eq(2).css({top: s})
        }

        function e(s) {
            a(s).on("click", function (t) {
                var e, i;
                t.preventDefault(), a(this).data("clickable") && (a(this).data("clickable", !1), a(s).toggleClass("cross"), a(s).hasClass("cross") ? (a(i = s).find("span").css({top: r}), setTimeout(function () {
        ...
        var o = a.extend({
            ...
            onOpen: null,
            onClose: null
        }, t), i = 0, r = o.height / 2 - o.barHeight / 2, s = o.height - o.barHeight;
    ...
    var d = l.event.special.mousewheel = {
        version: "3.1.12", setup: function () {
            if (this.addEventListener) for (var t = e.length; t;) this.addEventListener(e[--t], s, !1); else this.onmousewheel = s;
            l.data(this, "mousewheel-line-height", d.getLineHeight(this)), l.data(this, "mousewheel-page-height", d.getPageHeight(this))
        }, teardown: function () {
            if (this.removeEventListener) for (var t = e.length; t;) this.removeEventListener(e[--t], s, !1); else this.onmousewheel = null;
    ...
    function s(t) {
        var e, i = t || window.event, s = u.call(arguments, 1), n = 0, o = 0, r = 0, a = 0;
    ...
    function initMouseDetection(t) {
        ...
        mouseDetectionEnabled || t ? mouseDetectionEnabled && t && ($(document).off(e), mouseDetectionEnabled = !1) : (o = !0, r = null, (t = {
            mousemove: function (t) {
                var e, i, s, n = {x: t.pageX, y: t.pageY, timeStamp: (new Date).getTime()};
                r && (e = Math.abs(r.x - n.x), i = Math.abs(r.y - n.y), (0 < e || 0 < i) && e <= 4 && i <= 4 && n.timeStamp - r.timeStamp <= 300 && (mouse = !0, o) && ((s = $(t.target).closest("a")).is("a") && $.each(menuTrees, function () {
                    return $.contains(this.$root[0], s[0]) ? (this.itemEnter({currentTarget: s[0]}), !1) : void 0
                }), o = !1)), r = n
            }
    ...
    return $.SmartMenus = function (t, e) {
        ...
        hideAll: function () {
            ...
            init: function (t) {
                ...
                t || (menuTrees.push(this), this.rootId = ((new Date).getTime() + Math.random() + "").replace(/\D/g, ""), this.accessIdPrefix = "sm-" + this.rootId + "-", this.$root.hasClass("sm-rtl") && (this.opts.rightToLeftSubMenus = !0), t = ".smartmenus", this.$root.data("smartmenus", this).attr("data-smartmenus-id", this.rootId).dataSM("level", 1).on(getEventsNS({
                ...
                }, t)), $(window).on(getEventsNS({"resize orientationchange": $.proxy(this.winResize, this)}, t)), this.opts.subIndicators && (this.$subArrow = $("<span/>").addClass("sub-arrow"), this.opts.subIndicatorsText && this.$subArrow.html(this.opts.subIndicatorsText)), initMouseDetection()), this.$firstSub = this.$root.find("ul").each(function () {
                    o.menuInit($(this))
                    ...
                    var t = this.href.replace(i, ""), e = $(this);
                ...
                var e = t ? "Height" : "Width", t = document.documentElement["client" + e], e = window["inner" + e];
                ...
                var i, s, n = t.closest("ul"), o = n.dataSM("level");
                ...
                if (this.handleItemEvents(e)) {
                    ...
                    var i = e.dataSM("sub"), s = !!i && 2 == i.dataSM("level");
                    if (i) {
                        var n = $(t.target).is(".sub-arrow"), o = this.isCollapsible(),
                ...
                var t, i, s = e.dataSM("parent-a"), n = s.closest("li"), o = n.parent(), r = e.dataSM("level"),
                    a = this.getWidth(e), l = this.getHeight(e), h = s.offset(), c = h.left, u = h.top,
                    d = this.getWidth(s), p = this.getHeight(s), m = $(window), g = m.scrollLeft(), f = m.scrollTop(),
                    h = this.getViewportWidth(), s = this.getViewportHeight(),
                ...
                }).on(getEventsNS(m, s))))), e.css({top: "auto", left: "0", marginLeft: t, marginTop: r - p})
            }, menuScroll: function (t, e, i) {
                var s, n = t.dataSM("scroll"), o = t.dataSM("scroll-arrows"), r = n.up ? n.upEnd : n.downEnd;
                if (!e && n.momentum) {
                ...
                } : {marginTop: n.y}), mouse && (n.up && n.y > n.downEnd || !n.up && n.y < n.upEnd) && o.eq(n.up ? 1 : 0).show(), n.y == r ? (mouse && o.eq(n.up ? 0 : 1).hide(), this.menuScrollStop(t)) : e || (this.opts.scrollAccelerate && n.step < this.opts.scrollStep && (n.step += .2), (a = this).scrollTimeout = requestAnimationFrame(function () {
                    a.menuScroll(t)
                }))
                ...
                if (this.handleEvents()) switch (t.keyCode) {
                    ...
                    case 32:
                        var i, e = $(t.target);
                        e.is("a") && this.handleItemEvents(e) && (i = e.dataSM("sub")) && !i.is(":visible") && (this.itemClick({currentTarget: t.target}), t.preventDefault())
                }
            }, rootOut: function (t) {
                var e;
        ...
        subMenusMinWidth: "170px",
        subMenusMaxWidth: "60vw",
        subIndicators: !0,
    ...
    return a.extend(a.SmartMenus.Bootstrap = {}, {
        keydownFix: !1, init: function () {
            ...
            t.each(function () {
                var e, t, i, s = a(this), n = s.data("smartmenus");
                ...
                n || (e = s.is("[data-sm-skip-collapsible-behavior]"), t = s.hasClass("ml-auto") || 0 < s.prevAll(".mr-auto").length, s.smartmenus({
                    ...
                    "show.smapi": function (t, e) {
                        var i = a(e), e = i.dataSM("scroll-arrows");
    ...
    var s = 0, n = {}, p = window.Waypoint, t = window.onload;
    i.prototype.add = function (t) {
        ...
        for (t in s) {
            var n, o = s[t], r = o.newScroll > o.oldScroll ? o.forward : o.backward;
        ...
        var t, e, i = this.element == this.element.window, s = i ? void 0 : this.adapter.offset(), n = {};
        for (e in this.handleScroll(), t = {
            ...
            for (o in this.waypoints[e]) {
                var a, l = this.waypoints[e][o], h = l.options.offset, c = l.triggerPoint, u = 0, d = null == c;
    ...
    function x(t, e) {
        var i, s, n;
        if (t && e) for (n = I.parseSet(e), t = I.makeUrl(t), i = 0; i < n.length; i++) if (t === I.makeUrl(n[i].url)) {
            s = n[i];
            break
        }
        return s
        ...
        for (var u, d, s, n, o, r = e.length, a = 0, p = []; ;) {
            ...
            u = t(nt), d = [], "," === u.slice(-1) ? (u = u.replace(ot, ""), i()) : function () {
                for (t(it), s = "", n = "in descriptor"; ;) {
                    if (o = e.charAt(a), "in descriptor" === n) if (m(o)) s && (d.push(s), s = "", n = "after descriptor"); else {
                        if ("," === o) return a += 1, s && d.push(s), i();
                        if ("(" === o) s += o, n = "in parens"; else {
                            if ("" === o) return s && d.push(s), i();
                            s += o
                        }
                    } else if ("in parens" === n) if (")" === o) s += o, n = "in descriptor"; else {
    ...
    function i(t) {
        for (var e, i, s, n = /^(?:[+-]?[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?(?:ch|cm|em|ex|in|mm|pc|pt|px|rem|vh|vmin|vmax|vw)$/i, o = /^calc\((?:[0-9a-z \.\+\-\*\/\(\)]+)\)$/i, r = function (t) {
            ...
            for (var s, n = "", o = [], r = [], a = 0, l = 0, h = !1; ;) {
                ...
                if (h) "*" !== s || "/" !== t[l + 1] ? l += 1 : (h = !1, l += 2, e()); else {
                    if (m(s)) {
        ...
        }(t), a = r.length, l = 0; l < a; l++) if (i = (e = r[l])[e.length - 1], s = i, n.test(s) && 0 <= parseFloat(s) || (o.test(s) || ("0" === s || "-0" === s || "+0" === s))) {
    ...
    var r, c, a, l, u, d, p, g, f, y, v, b, _, T, k, A, C, E, $, M, I = {}, P = !1, O = o.createElement("img"),
        L = O.getAttribute, z = O.setAttribute, j = O.removeAttribute, N = o.documentElement, D = {},
        F = {algorithm: ""}, H = "data-pfsrc", q = H + "set", W = navigator.userAgent,
        R = /rident/.test(W) || /ecko/.test(W) && W.match(/rv\:(\d+)/) && 35 < RegExp.$1, B = "currentSrc",
        Y = /\s+\+?\d+(e\d+)?w/, V = /(\([^)]+\))?\s*(.+)/, X = t.picturefillCFG, U = "font-size:100%!important;",
        Q = !0, G = {}, Z = {}, K = t.devicePixelRatio, J = {px: 1, in: 96}, tt = o.createElement("a"), et = !1,
        it = /^[ \t\n\r\u000c]+/, st = /^[, \t\n\r\u000c]+/, nt = /^[^ \t\n\r\u000c]+/, ot = /[,]+$/, rt = /^\d+$/,
        at = /^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/, W = function (e) {
            var i = {};
            return function (t) {
            ...
            var i;
            if (!(t in G)) if (G[t] = !1, e && (i = t.match(l))) G[t] = i[1] * J[i[2]]; else try {
    ...
    t.console && console.warn, B in O || (B = "src"), D["image/jpeg"] = !0, D["image/gif"] = !0, D["image/png"] = !0, D["image/svg+xml"] = o.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1"), I.ns = ("pf" + (new Date).getTime()).substr(0, 9), I.supSrcset = "srcset" in O, I.supSizes = "sizes" in O, I.supPicture = !!t.HTMLPictureElement, I.supSrcset && I.supPicture && !I.supSizes && (C = o.createElement("img"), O.srcset = "data:,a", C.src = "data:,a", I.supSrcset = O.complete === C.complete, I.supPicture = I.supSrcset && I.supPicture), I.supSrcset && !I.supSizes ? (C = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", (A = o.createElement("img")).onload = ct, A.onerror = ct, A.setAttribute("sizes", "9px"), A.srcset = C + " 1w,data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw== 9w", A.src = C) : P = !0, I.selShort = "picture>img,img[srcset]", I.sel = I.selShort, I.cfg = F, I.DPR = K || 1, I.u = J, I.types = D, I.setSize = s, I.makeUrl = W(function (t) {
        ...
        if (t) for (var e, i = 0, s = (e = I.parseSet(t)).length; i < s; i++) S(e[i], t.sizes);
        return e
    }, I.setRes.res = S, I.applySetCandidate = function (t, e) {
        if (t.length) {
            var i, s, n, o, r, a, l = e[I.ns], h = I.DPR, c = l.curSrc || e[B],
            ...
            if (u && u.set === t[0].set && ((a = R && !e.complete && u.res - .1 > h) || (u.cached = !0, u.res >= h && (r = u))), !r) for (t.sort(w), r = t[(o = t.length) - 1], s = 0; s < o; s++) if ((i = t[s]).res >= h) {
        ...
        for (var e, i, s = !1, n = t[I.ns].sets, o = 0; o < n.length && !s; o++) if ((e = n[o]).srcset && I.matchesMedia(e.media) && (i = I.supportsType(e.type))) {
            s = e = "pending" === i ? i : e;
            break
        }
        return s
    }, I.parseSets = function (t, e, i) {
        var s, n, o, r, a = e && "PICTURE" === e.nodeName.toUpperCase(), l = t[I.ns];
        ...
        push: function (t) {
            var e = t.shift();
            "function" == typeof I[e] ? I[e].apply(I, t) : (F[e] = t[0], et && I.fillImgs({reselect: !0}))
        }
    };
    ...
    t.picturefill = ht, "object" == typeof module && "object" == typeof module.exports ? module.exports = ht : "function" == typeof define && define.amd && define("picturefill", function () {
        return ht
    }), I.supPicture || (D["image/webp"] = (E = "image/webp", $ = "data:image/webp;base64,UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAwAAAABBxAR/Q9ERP8DAABWUDggGAAAADABAJ0BKgEAAQADADQlpAADcAD++/1QAA==", (M = new t.Image).onerror = function () {
        D[E] = !1, ht()
    }, M.onload = function () {
        D[E] = 1 === M.width, ht()
    }, M.src = $, "pending"))
    ...
    var f, y, v = (y = [{
        ...
        key: "listeners", value: function (t) {
            var e = this, i = t ? "addEventListener" : "removeEventListener";
        ...
        key: "get", value: function (t) {
            ...
            var e = t.target, i = t.changedTouches[0], s = parseFloat(e.getAttribute("min")) || 0,
                n = parseFloat(e.getAttribute("max")) || 100, o = parseFloat(e.getAttribute("step")) || 1,
                t = e.getBoundingClientRect(), e = 100 / t.width * (this.config.thumbWidth / 2) / 100;
        ...
        key: "set", value: function (t) {
            var e;
            b.enabled && c(t) && !t.target.disabled && (t.preventDefault(), t.target.value = this.get(t), e = t.target, t = "touchend" === t.type ? "change" : "input", e && t && (t = new Event(t, {bubbles: !0}), e.dispatchEvent(t)))
        }
    }], Kt = [{
        key: "setup", value: function (i) {
            var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, t = null;
            ...
            }).observe(document.body, {childList: !0, subtree: !0}), t.map(function (t) {
                return new b(t, e)
            })
        }
    }, {
    ...
    const w = t => null != t ? t.constructor : null, x = (t, e) => Boolean(t && e && t instanceof e),
        S = t => null == t, _ = t => w(t) === Object, T = t => w(t) === String, k = t => w(t) === Function,
        A = t => Array.isArray(t), C = t => x(t, NodeList),
        E = t => S(t) || (T(t) || A(t) || C(t)) && !t.length || _(t) && !Object.keys(t).length;
    var $ = S, M = _, I = t => w(t) === Number && !Number.isNaN(t), P = T, O = t => w(t) === Boolean, L = k, z = A,
        j = C,
        N = t => null !== t && "object" == typeof t && 1 === t.nodeType && "object" == typeof t.style && "object" == typeof t.ownerDocument,
        D = t => x(t, Event), F = t => x(t, KeyboardEvent), H = t => x(t, TextTrack) || !S(t) && T(t.kind), q = t => {
    ...
    function X(e = {}, ...t) {
        ...
        return M(i) ? (Object.keys(i).forEach(t => {
            M(i[t]) ? (Object.keys(e).includes(t) || Object.assign(e, {[t]: {}}), X(e[t], i[t])) : Object.assign(e, {[t]: i[t]})
        }), X(e, ...t)) : e
    }
    ...
    function U(t, o) {
        ...
        Array.from(t).reverse().forEach((t, e) => {
            const i = 0 < e ? o.cloneNode(!0) : o, s = t.parentNode, n = t.nextSibling;
    ...
    function et(t, e) {
        ...
        return t.split(",").forEach(t => {
            const e = t.trim(), i = e.replace(".", ""), s = e.replace(/[[\]]/g, "").split("="), [n] = s,
    ...
    function lt(t = null, e = !1) {
        N(t) && (t.focus({preventScroll: !0}), e && st(t, this.config.classNames.tabFocus))
    }
    ...
    const ht = {
        ...
        check(t, e, i) {
            ...
            return {api: e, ui: e && ct.rangeInput && ("video" !== t || !Y.isIPhone || i)}
        },
        ...
        let t = !1;
        try {
            var e = Object.defineProperty({}, "passive", {get: () => (t = !0, null)});
    ...
    function dt(i, t, s, n = !1, o = !0, r = !1) {
        if (i && "addEventListener" in i && !W(t) && L(s)) {
            const a = t.split(" ");
            let e = r;
            ut && (e = {passive: o, capture: r}), a.forEach(t => {
    ...
    function ft(t, e = "", i = !1, s = {}) {
        N(t) && !W(e) && (s = new CustomEvent(e, {bubbles: i, detail: {...s, plyr: this}}), t.dispatchEvent(s))
    }
    ...
    const xt = [[1, 1], [4, 3], [3, 4], [5, 4], [4, 5], [3, 2], [2, 3], [16, 10], [10, 16], [16, 9], [9, 16], [21, 9], [9, 21], [32, 9], [9, 32]].reduce((t, [e, i]) => ({
        ...t,
        [e / i]: [e, i]
    }), {});
    ...
    function Tt(t) {
        ...
        let i = e(t);
        if (null === i && (i = e(this.config.ratio)), null === i && !W(this.embed) && z(this.embed.ratio) && ({ratio: i} = this.embed), null === i && this.isHTML5) {
    ...
    function kt(t) {
        ...
        const {wrapper: e} = this.elements, i = Tt.call(this, t);
        if (!z(i)) return {};
    ...
    function At(t, e, i = .05) {
        var s = t / e, n = bt(Object.keys(xt), s);
            ...
            if (this.isHTML5) {
                ...
                a.options.speed = a.config.speed.options, W(this.config.ratio) || kt.call(a), Object.defineProperty(a.media, "quality", {
                    get() {
                        ...
                        if (a.quality !== e) {
                            if (a.config.quality.forced && L(a.config.quality.onChange)) a.config.quality.onChange(e); else {
                                const t = Ct.getSources.call(a).find(t => Number(t.getAttribute("size")) === e);
                                if (!t) return;
                                const {currentTime: i, paused: s, preload: n, readyState: o, playbackRate: r} = a.media;
    ...
    const Pt = {pip: "PIP", airplay: "AirPlay", html5: "HTML5", vimeo: "Vimeo", youtube: "YouTube"}, Ot = {
        get(t = "", e = {}) {
            if (W(t) || W(e)) return "";
            let i = V(e.i18n, t);
    ...
    function zt(t, s = "text") {
        return new Promise((e, i) => {
            try {
                ...
                }), i.open("GET.html", t, !0), i.responseType = s, i.send()
            } catch (t) {
                i(t)
            }
        })
    ...
    function jt(t, e) {
        if (P(t)) {
            const i = P(e);
            const s = () => null !== document.getElementById(e), n = (t, e) => {
                t.innerHTML = e, i && s() || document.body.insertAdjacentElement("afterbegin", t)
            };
            if (!i || !s()) {
                const s = Lt.supported, o = document.createElement("div");
                ...
                zt(t).then(t => {
                    W(t) || (s && window.localStorage.setItem(`cache-${e}`, JSON.stringify({content: t})), n(o, t))
                }).catch(() => {
                })
            }
        }
    ...
    function Dt(t = 0, e = !1, i = !1) {
        ...
        var s = t => `0${t}`.slice(-2);
        let n = Nt(t);
        var o = Math.trunc(t / 60 % 60, 10), r = Math.trunc(t % 60, 10);
        return n = e || 0 < n ? `${n}:` : "", `${i && 0 < t ? "-" : ""}${n}${s(o)}:${s(r)}`
    }

    const Ft = {
        getIconUrl() {
            var t = new URL(this.config.iconUrl).
            host !== window.location.host || Y.isIE && !window.svg4everybody;
            ...
            const i = "http://www.w3.org/2000/svg", s = Ft.getIconUrl.call(this),
                n = `${s.cors ? "" : s.url}#${this.config.iconPrefix}`, o = document.createElementNS(i, "svg");
            Q(o, X(e, {"aria-hidden": "true", focusable: "false"}));
            const r = document.createElementNS(i, "use"), a = `${n}-${t}`;
            ...
            return G("span", {...e, class: [e.class, this.config.classNames.hidden].filter(Boolean).join(" ")}, t)
        }, createBadge(t) {
            if (W(t)) return null;
            const e = G("span", {class: this.config.classNames.menu.value});
            return e.appendChild(G("span", {class: this.config.classNames.menu.badge}, t)), e
        }, createButton(t, e) {
            const i = X({}, e);
            let s = function (t = "") {
                let e = t.toString();
            ...
            }), "button" !== n.element || Object.keys(i).includes("type") || (i.type = "button"), Object.keys(i).includes("class") ? i.class.split(" ").some(t => t === this.config.classNames.control) || X(i, {class: `${i.class} ${this.config.classNames.control}`}) : i.class = this.config.classNames.control, t) {
                case"play":
            ...
            if ("volume" !== t) {
                ...
                const e = {played: "played", buffer: "buffered"}[t], s = e ? Ot.get(e, this.config) : "";
            ...
            pt.call(this, s, "keydown keyup", e => {
                if ([32, 38, 39, 40].includes(e.which) && (e.preventDefault(), e.stopPropagation(), "keydown" !== e.type)) {
                    ...
                    if (!i && [32, 39].includes(e.which)) Ft.showMenuPanel.call(this, t, !0); else {
                        let t;
        ...
        }, createMenuItem({value: e, list: t, type: i, title: s, badge: n = null, checked: o = !1}) {
            const r = et(this.config.selectors.inputs[i]), a = G("button", X(r, {
                type: "button",
                role: "menuitemradio",
            ...
            if (this.supported.ui && D(t)) {
                var e, i, s, n = (t, e) => {
                    const i = I(e) ? e : 0, s = N(t) ? t : this.elements.display.buffer;
                    if (N(s)) {
                        s.value = i;
            ...
            if (N(e) && "range" === e.getAttribute("type")) {
                if (ot(e, this.config.selectors.inputs.seek)) {
                    ...
                    const t = Ft.formatTime(this.currentTime), i = Ft.formatTime(this.duration),
            ...
            if (this.config.tooltips.seek && N(this.elements.inputs.seek) && N(this.elements.display.seekTooltip) && 0 !== this.duration) {
                ...
                if (this.touch) n(!1); else {
                    ...
                    if (D(e)) t = 100 / i.width * (e.pageX - i.left); else {
            ...
            let n = null, o = e;
            if ("captions" === t) n = this.currentTrack; else {
            ...
            if (N(this.elements.settings.panels.quality)) {
                const e = "quality", i = this.elements.settings.panels.quality.querySelector('[role="menu"]');
            ...
            if (N(this.elements.settings.panels.captions)) {
                const t = "captions", i = this.elements.settings.panels.captions.querySelector('[role="menu"]'),
                    e = Wt.getTracks.call(this), s = Boolean(e.length);
            ...
            var {buttons: t} = this.elements.settings, t = !W(t) && Object.values(t).some(t => !t.hidden);
            ...
            const {popup: i} = this.elements.settings, s = this.elements.buttons.settings;
            if (N(i) && N(s)) {
                const {hidden: n} = i;
                let t = n;
                if (O(e)) t = e; else if (F(e) && 27 === e.which) t = !1; else if (D(e)) {
                    const n = L(e.composedPath) ? e.composedPath()[0] : e.target, o = i.contains(n);
            ...
            return vt(z(this.config.controls) ? this.config.controls : []).forEach(e => {
                if ("restart" === e && o.appendChild(i.call(this, "restart", u)), "rewind" === e && o.appendChild(i.call(this, "rewind", u)), "play" === e && o.appendChild(i.call(this, "play", u)), "fast-forward" === e && o.appendChild(i.call(this, "fast-forward", u)), "progress" === e) {
                    const l = G("div", {class: `${u.class} plyr__progress__container`}),
                        i = G("div", et(this.config.selectors.progress));
                    if (i.appendChild(s.call(this, "seek", {id: `plyr-seek-${a.id}`})), i.appendChild(t.call(this, "buffer")), this.config.tooltips.seek) {
                        const a = G("span", {class: this.config.classNames.tooltip}, "00:00");
                ...
                if ("current-time" === e && o.appendChild(h.call(this, "currentTime", u)), "duration" === e && o.appendChild(h.call(this, "duration", u)), "mute" === e || "volume" === e) {
                    ...
                    if (N(t) && o.contains(t) || (t = G("div", X({}, u, {class: `${u.class} plyr__volume`.trim()})), this.elements.volume = t, o.appendChild(t)), "mute" === e && t.appendChild(i.call(this, "mute")), "volume" === e && !Y.isIos) {
                        const i = {max: 1, step: .05, value: this.config.volume};
                        t.appendChild(s.call(this, "volume", X(i, {id: `plyr-volume-${a.id}`})))
                    }
                }
                if ("captions" === e && o.appendChild(i.call(this, "captions", u)), "settings" === e && !W(this.config.settings)) {
                    const t = G("div", X({}, u, {class: `${u.class} plyr__menu`.trim(), hidden: ""}));
                    t.appendChild(i.call(this, "settings", {
                        "aria-haspopup": !0,
                        "aria-controls": `plyr-settings-${a.id}`,
                        "aria-expanded": !1
                    }));
                    const s = G("div", {class: "plyr__menu__container", id: `plyr-settings-${a.id}`, hidden: ""}),
                        h = G("div"), e = G("div", {id: `plyr-settings-${a.id}-home`}), r = G("div", {role: "menu"});
                    e.appendChild(r), h.appendChild(e), this.elements.settings.panels.home = e, this.config.settings.forEach(t => {
                        ...
                        const i = G("span", null, Ot.get(t, this.config)),
                            s = G("span", {class: this.config.classNames.menu.value});
                        s.innerHTML = a[t], i.appendChild(s), e.appendChild(i), r.appendChild(e);
                        const n = G("div", {id: `plyr-settings-${a.id}-${t}`, hidden: ""}), o = G("button", {
                            type: "button",
                            class: `${this.config.classNames.control} ${this.config.classNames.control}--back`
                        });
                        o.appendChild(G("span", {"aria-hidden": !0}, Ot.get(t, this.config))), o.appendChild(G("span", {class: this.config.classNames.hidden}, Ot.get("menuBack", this.config))), pt.call(this, n, "keydown", t => {
                            37 === t.which && (t.preventDefault(), t.stopPropagation(), c.call(this, "home", !0))
                        }, !1), pt.call(this, o, "click", () => {
                            c.call(this, "home", !1)
                        }), n.appendChild(o), n.appendChild(G("div", {role: "menu"})), h.appendChild(n), this.elements.settings.buttons[t] = e, this.elements.settings.panels[t] = n
                ...
                if ("pip" === e && ct.pip && o.appendChild(i.call(this, "pip", u)), "airplay" === e && ct.airplay && o.appendChild(i.call(this, "airplay", u)), "download" === e) {
                    const a = X({}, u, {element: "a", href: this.download, target: "_blank"});
            ...
            if (i && P(this.config.controls) && (e = (() => {
                ...
                const e = e => {
                    ...
                    Object.defineProperty(e, "pressed", {
                        enumerable: !0, get: () => nt(e, i), set(t = !1) {
                            st(e, i, t)
                        }
                    })
                };
    ...
    const Wt = {
        setup() {
            if (this.supported.ui) if (!this.isVideo || this.isYouTube || this.isHTML5 && !ct.textTracks) z(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && Ft.setCaptionsMenu.call(this); else {
                var i;
                if (N(this.elements.captions) || (this.elements.captions = G("div", et(this.config.selectors.captions)), i = this.elements.captions, s = this.elements.wrapper, N(i) && N(s) && s.parentNode.insertBefore(i, s.nextSibling)), Y.isIE && window.URL) {
                    ...
                    Array.from(i).forEach(e => {
                        var t = e.getAttribute("src"), i = Ht(t);
                ...
                if (O(e) || ({active: e} = this.config.captions), Object.assign(this.captions, {
                    toggled: !1,
                    active: e,
                    language: t,
                    languages: s
            ...
            const t = Wt.getTracks.call(this, !0), {
                ...
                meta: s,
                currentTrackNode: n
            } = this.captions, o = Boolean(t.find(t => t.language === i));
            this.isHTML5 && this.isVideo && t.filter(t => !s.get(t)).forEach(t => {
                this.debug.log("Track added", t), s.set(t, {default: "showing" === t.mode}), "showing" === t.mode && (t.mode = "hidden"), pt.call(this, t, "cuechange", () => Wt.updateCues.call(this))
            ...
            if (this.supported.ui) {
                const {toggled: i} = this.captions, s = this.config.classNames.captions.active, n = $(t) ? !i : t;
                if (n !== i) {
            ...
            var i, s = Wt.getTracks.call(this);
            -1 !== t ? I(t) ? t in s ? (this.captions.currentTrack !== t && ({language: s} = (i = s[this.captions.currentTrack = t]) || {}, this.captions.currentTrackNode = i, Ft.updateSetting.call(this, "captions"), e || (this.captions.language = s, this.storage.set({language: s})), this.isVimeo && this.embed.enableTextTrack(s), ft.call(this, this.media, "languagechange")), Wt.toggle.call(this, !0, e), this.isHTML5 && this.isVideo && Wt.updateCues.call(this)) : this.debug.warn("Track not found", t) : this.debug.warn("Invalid caption argument", t) : Wt.toggle.call(this, !1, e)
        }, setLanguage(t, e = !0) {
            if (P(t)) {
                var i = t.toLowerCase();
                this.captions.language = i;
                const s = Wt.getTracks.call(this), n = Wt.findTrack.call(this, [i]);
            ...
            const i = Wt.getTracks.call(this), s = t => Number((this.captions.meta.get(t) || {}).default),
            ...
            if (this.supported.ui) if (N(this.elements.captions)) if ($(e) || Array.isArray(e)) {
                let t = e;
                if (!t) {
    ...
    }, Bt = "picture-in-picture", Yt = {html5: "html5", youtube: "youtube", vimeo: "vimeo"}, Vt = () => {
    };
            ...
            o(this, "onChange", () => {
                ...
                if (!Y.isIos && this.active && "Tab" === t.key && 9 === t.keyCode) {
                    const e = document.activeElement,
                        i = rt.call(this.player, "a[href], button:not(:disabled), input:not(:disabled), [tabindex]"), [s] = i,
                        n = i[i.length - 1];
                ...
                this.enabled && (Y.isIos && this.player.config.fullscreen.iosNative ? this.player.isVimeo ? this.player.embed.requestFullscreen() : this.target.webkitEnterFullscreen() : !Ut.native || this.forceFallback ? this.toggleFallback(!0) : this.prefix ? W(this.prefix) || this.target[`${this.prefix}Request${this.property}`]() : this.target.requestFullscreen({navigationUI: "hide"}))
            }), o(this, "exit", () => {
                var t;
    ...
    const Gt = {
        addStyleHook() {
            ...
            }, 0), Gt.setTitle.call(this), this.poster && Gt.setPoster.call(this, this.poster, !1).catch(() => {
            ...
            if (P(this.config.title) && !W(this.config.title) && (e += `, ${this.config.title}`), Array.from(this.elements.buttons.play || []).forEach(t => {
                ...
                if (N(e)) {
                    const t = W(this.config.title) ? "video" : this.config.title, i = Ot.get("frameTitle", this.config);
            ...
            return t && this.poster ? Promise.reject(new Error("Poster already set")) : (this.media.setAttribute("data-poster", e), this.elements.poster.removeAttribute("hidden"), function () {
                ...
                backgroundImage: `url('%24%7be%7d.html')`,
                backgroundSize: ""
            ...
            st(this.elements.container, this.config.classNames.playing, this.playing), st(this.elements.container, this.config.classNames.paused, this.paused), st(this.elements.container, this.config.classNames.stopped, this.stopped), Array.from(this.elements.buttons.play || []).forEach(t => {
                Object.assign(t, {pressed: this.playing}), t.setAttribute("aria-label", Ot.get(this.playing ? "pause" : "play", this.config))
            ...
            var e, {controls: i} = this.elements;
            ...
            Object.values({...this.media.style}).filter(t => !W(t) && P(t) && t.startsWith("--plyr")).forEach(t => {
    ...
    class Zt {
        constructor(t) {
            o(this, "firstTouch", () => {
                ...
                const {player: a} = this, {config: t, elements: l, timers: s} = a;
                ...
                const i = () => {
                    if (a.isVimeo && !a.config.vimeo.premium) {
                        const i = l.wrapper, {active: s} = a.fullscreen, [n, o] = Tt.call(a),
                ...
                const {player: i} = this, {elements: s} = i;
                ...
                i.supported.ui && i.config.disableContextMenu && pt.call(i, s.wrapper, "contextmenu", t => {
                    ...
                    Ft.updateSetting.call(i, "speed"), i.storage.set({speed: i.speed})
                ...
                var {player: o} = this, r = o.config.listeners[s], r = L(r);
                pt.call(o, t, e, t => this.proxy(t, i, s), n && !r)
            }), o(this, "controls", () => {
                const {player: r} = this, {elements: s} = r, e = Y.isIE ? "change" : "input";
                if (s.buttons.play && Array.from(s.buttons.play).forEach(t => {
                    ...
                    var e = s.progress.getBoundingClientRect(), e = 100 / e.width * (t.pageX - e.left);
                    t.currentTarget.setAttribute("seek-value", e)
                }), this.bind(s.inputs.seek, "mousedown mouseup keydown keyup touchstart touchend", t => {
                    const e = t.currentTarget, i = t.keyCode || t.which, s = "play-on-seeked";
                    var n;
                ...
                this.bind(s.inputs.seek, e, t => {
                    ...
                    const e = t.webkitDirectionInvertedFromDevice, [i, s] = [t.deltaX, -t.deltaY].map(t => e ? -t : t),
        ...
        handleKey(t) {
            const {player: e} = this, {elements: i} = e, s = t.keyCode || t.which, n = "keydown" === t.type,
                o = n && s === this.lastKey;
            if (!(t.altKey || t.ctrlKey || t.metaKey || t.shiftKey) && I(s)) if (n) {
                const n = document.activeElement;
                if (N(n)) {
                    const {editable: s} = e.config.selectors, {seek: o} = i.inputs;
    ...
    var Kt, Jt = (0, function () {
        ...
        function a(t, e) {
            if (t) {
                var i = h[t];
                if (l[t] = e, i) for (; i.length;) i[0](t, e), i.splice(0, 1)
            }
        }

        function c(t, e) {
            t.call && (t = {success: t}), e.length ? (t.error || p)(e) : (t.success || p)(t)
        }
        ...
        function u(t, s, e) {
            for (var n = (t = t.push ? t : [t]).length, i = n, o = [], r = function (t, e, i) {
                ...
                var a, l, t = document, e = o.async, h = (o.numRetries || 0) + 1, c = o.before || p,
                    u = s.replace(/[\?|#].*$/, ""), d = s.replace(/^(css|img)!/, "");
    ...
    const ie = {
        setup() {
            ...
            const r = this, t = r.config.vimeo, {premium: e, referrerPolicy: i, ...s} = t;
            ...
            const l = G("iframe"), h = Et(r.config.urls.vimeo.iframe, a, n);
            if (l.setAttribute("src", h), l.setAttribute("allowfullscreen", ""), l.setAttribute("allow", ["autoplay", "fullscreen", "picture-in-picture", "encrypted-media", "accelerometer", "gyroscope"].join("; ")), W(i) || l.setAttribute("referrerPolicy", i), e || !t.customControls) l.setAttribute("data-poster", r.poster), r.media = tt(l, r.media); else {
                const t = G("div", {class: r.config.classNames.embedContainer, "data-poster": r.poster});
            ...
            Object.defineProperty(r.media, "currentTime", {
                get: () => c, set(t) {
                    const {embed: e, media: i, paused: s, volume: n} = r, o = s && !e.hasPlayed;
            ...
            Object.defineProperty(r.media, "loop", {
                ...
                this.debug.warn(t)
            }), Object.defineProperty(r.media, "currentSrc", {get: () => m}), Object.defineProperty(r.media, "ended", {get: () => r.currentTime === r.duration}), Promise.all([r.embed.getVideoWidth(), r.embed.getVideoHeight()]).then(t => {
                var [e, t] = t;
    ...
    const ne = {
        setup() {
            if (st(this.elements.wrapper, this.config.classNames.embed, !0), M(window.YT) && L(window.YT.Player)) ne.ready.call(this); else {
            ...
            const o = this, r = o.config.youtube, t = o.media && o.media.getAttribute("id");
                    ...
                    events: {
                        onError(t) {
                            ...
                            if (!L(o.media.play)) {
                                ...
                                }), Object.defineProperty(o.media, "currentSrc", {get: () => s.getVideoUrl()}), Object.defineProperty(o.media, "ended", {get: () => o.currentTime === o.duration});
                            ...
                            ft.call(o, o.elements.container, "statechange", !1, {code: t.data})
                        }
                    }
                })
            }
        ...
        setup() {
            this.media ? (st(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0), st(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), !0), this.isEmbed && st(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0), this.isVideo && (this.elements.wrapper = G("div", {class: this.config.classNames.video}), U(this.media, this.elements.wrapper), this.elements.poster = G("div", {class: this.config.classNames.poster}), this.elements.wrapper.appendChild(this.elements.poster)), this.isHTML5 ? Ct.setup.call(this) : this.isYouTube ? ne.setup.call(this) : this.isVimeo && ie.setup.call(this)) : this.debug.warn("No media element found!")
        }
    };
    ...
    class re {
                    ...
                    if (0 !== t && -1 !== t && t < this.player.duration) {
                        ...
                        if (N(e)) {
                            const i = 100 / this.player.duration * t,
                                s = G("span", {class: this.player.config.classNames.cues});
                            s.style.left = `${i.toString()}%`, e.appendChild(s)
                        }
                    }
                })
            }), o(this, "onAdEvent", t => {
                const {container: e} = this.player.elements, i = t.getAd(), s = t.getAdData();
        ...
        get tagUrl() {
            var {config: t} = this;
            return q(t.tagUrl) ? t.tagUrl : `https://go.aniview.com/api/adserver6/vast/?${qt({
    ...
    class le {
        constructor(t) {
            o(this, "load", () => {
                ...
                this.elements.thumb.container = G("div", {class: this.player.config.classNames.previewThumbnails.thumbContainer}), this.elements.thumb.imageContainer = G("div", {class: this.player.config.classNames.previewThumbnails.imageContainer}), this.elements.thumb.container.appendChild(this.elements.thumb.imageContainer);
                const t = G("div", {class: this.player.config.classNames.previewThumbnails.timeContainer});
                this.elements.thumb.time = G("span", {}, "00:00"), t.appendChild(this.elements.thumb.time), this.elements.thumb.container.appendChild(t), N(this.player.elements.progress) && this.player.elements.progress.appendChild(this.elements.thumb.container), this.elements.scrubbing.container = G("div", {class: this.player.config.classNames.previewThumbnails.scrubbingContainer}), this.player.elements.wrapper.appendChild(this.elements.scrubbing.container)
            }), o(this, "destroy", () => {
                ...
                const e = this.showingThumb, i = this.thumbnails[t], {urlPrefix: s} = i, n = i.frames[e],
                    o = i.frames[e].text, r = s + o;
                if (this.currentImageElement && this.currentImageElement.dataset.filename === o) this.showImage(this.currentImageElement, n, t, e, o, !1), this.currentImageElement.dataset.index = e, this.removeOldImages(this.currentImageElement); else {
                    ...
                    if (this.showingThumbFilename === n) {
                        ...
                        t.forEach(t => {
                            ...
                            if (e !== n && !this.loadedImages.includes(e)) {
                                ...
                                const {urlPrefix: t} = this.thumbnails[0], n = t + e, i = new Image;
                                i.src = n, i.onload = () => {
                ...
                const t = this.player.elements.progress.getBoundingClientRect(),
                    e = this.player.elements.container.getBoundingClientRect(), {container: i} = this.elements.thumb,
                    s = e.left - t.left + 10, n = e.right - t.left - i.clientWidth - 10;
    ...
    const he = {
        insertElements(e, t) {
            P(t) ? Z(e, this.media, {src: t}) : z(t) && t.forEach(t => {
                Z(e, this.media, t)
            })
        }, change(o) {
            V(o, "sources.length") ? (Ct.cancelRequests.call(this), this.destroy.call(this, () => {
                ...
                var {sources: t, type: e} = o, [{provider: i = Yt.html5, src: s}] = t, n = "html5" === i ? e : "div",
                    s = "html5" === i ? {} : {src: s};
                Object.assign(this, {
                    provider: i,
                    type: e,
    ...
    class ce {
        constructor(t, e) {
            if (o(this, "play", () => L(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then(() => this.ads.play()).catch(() => yt(this.media.play())), this.media.play()) : null), o(this, "pause", () => this.playing && L(this.media.pause) ? this.media.pause() : null), o(this, "togglePlay", t => (O(t) ? t : !this.playing) ? this.play() : this.pause()), o(this, "stop", () => {
                ...
                speed: [],
                quality: []
            }, this.debug = new Xt(this.config.debug), this.debug.log("Config", this.config), this.debug.log("Support", ct), !$(this.media) && N(this.media)) if (this.media.plyr) this.debug.warn("Target already setup"); else if (this.config.enabled) if (ct.check().api) {
                ...
                this.supported = ct.check(this.type, this.provider, this.config.playsinline), this.supported.api ? (this.eventListeners = [], this.listeners = new Zt(this), this.storage = new Lt(this), this.media.plyr = this, N(this.elements.container) || (this.elements.container = G("div", {tabindex: 0}), U(this.media, this.elements.container)), Gt.migrateStyles.call(this), Gt.addStyleHook.call(this), oe.setup.call(this), this.config.debug && pt.call(this, this.elements.container, this.config.events.join(" "), t => {
        ...
        get duration() {
            var t = parseFloat(this.config.duration), e = (this.media || {}).duration, e = I(e) && e !== 1 / 0 ? e : 0;
            return t || e
        }
        ...
        set volume(t) {
            let e = t;
            P(e) && (e = Number(e)), I(e) || (e = this.storage.get("volume")), I(e) || ({volume: e} = this.config), 1 < e && (e = 1), e < 0 && (e = 0), this.config.volume = e, this.media.volume = e, !W(t) && this.muted && 0 < e && (this.muted = !1)
        }
        ...
        set quality(i) {
            ...
            if (n.length) {
                let t = [!W(i) && Number(i), this.storage.get("quality"), s.selected, s.default].find(I), e = !0;
                if (!n.includes(t)) {
                    const i = bt(n, t);
                    this.debug.warn(`Unsupported quality option: ${t}, using ${i} instead`), t = i, e = !1
                }
                s.selected = t, this.media.quality = t, e && this.storage.set({quality: t})
            }
        }
        ...
        set poster(t) {
            this.isVideo ? Gt.setPoster.call(this, t, !1).catch(() => {
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = function (l) {
        var h = /\blang(?:uage)?-([\w-]+)\b/i, e = 0, t = {}, M = {
            ...
            languages: {
                plain: t, plaintext: t, text: t, txt: t, extend: function (t, e) {
                    var i, s = M.util.clone(M.languages[t]);
                    for (i in e) s[i] = e[i];
                    return s
                }, insertBefore: function (i, t, e, s) {
                    var n, o = (s = s || M.languages)[i], r = {};
                    for (n in o) if (o.hasOwnProperty(n)) {
                        if (n == t) for (var a in e) e.hasOwnProperty(a) && (r[a] = e[a]);
            ...
            highlightElement: function (t, e, i) {
                var s = M.util.getLanguage(t), n = M.languages[s];
            ...
            tokenize: function (t, e) {
                ...
                var n = new o;
                return O(n, n.head, t), function t(e, i, s, n, o, r) {
                    for (var a in s) if (s.hasOwnProperty(a) && s[a]) for (var l = s[a], l = Array.isArray(l) ? l : [l], h = 0; h < l.length; ++h) {
                        if (r && r.cause == a + "," + h) return;
                        var c, u = l[h], d = u.inside, p = !!u.lookbehind, m = !!u.greedy, g = u.alias;
                        ...
                        for (var f = u.pattern || u, y = n.next, v = o; y !== i.tail && !(r && v >= r.reach); v += y.value.length, y = y.next) {
                            ...
                            if (!(b instanceof I)) {
                                ...
                                if (m) {
                                    ...
                                    var S = w.index, _ = w.index + w[0].length, T = v;
                                ...
                                var S = w.index, A = w[0], C = b.slice(0, S), E = b.slice(S + A.length),
                                    $ = v + b.length;
                                r && $ > r.reach && (r.reach = $);
                                b = y.prev;
                                C && (b = O(i, b, C), v += C.length), function (t, e, i) {
        ...
        function O(t, e, i) {
            var s = e.next, i = {value: i, prev: e, next: s};
        ...
        if (l.Prism = M, I.stringify = function e(t, i) {
            ...
            var e = JSON.parse(t.data), i = e.language, t = e.code, e = e.immediateClose;
...
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
...
}), Prism.languages.html = Prism.languages.markup, Prism.languages.mathml = Prism.languages.markup, Prism.languages.svg = Prism.languages.markup, Prism.languages.xml = Prism.languages.extend("markup", {}), Prism.languages.ssml = Prism.languages.xml, Prism.languages.atom = Prism.languages.xml, Prism.languages.rss = Prism.languages.xml, function (t) {
    var e = /(?:"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"|'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n])*')/;
    t.languages.css = {
        comment: /\/\*[\s\S]*?\*\//,
        atrule: {
    ...
    var t = /\/\*[\s\S]*?\*\/|\/\/.*|#(?!\[).*/, i = [{pattern: /\b(?:false|true)\b/i, alias: "boolean"}, {
    ...
    var r = {
        ...
        greedy: !0
    }, {pattern: /"(?:\\[\s\S]|[^\\"])*"/, alias: "double-quoted-string", greedy: !0, inside: {interpolation: r}}];
    ...
    return function s(n, o, r) {
        ...
        1: [function (t, T, k) {
            !function () {
                var h, r, a, o, l, c, s, u, e, d, p, v = this || Function("return this")(), m = function () {
                    "use strict";
                    ...
                    function d(e, i) {
                        var s = t.prototype.filter, n = e._filterArgs;
                        o(s, function (t) {
                    ...
                    return t.prototype.tween = function (t) {
                        ...
                        var i = this._currentState, s = this._targetState;
                ...
                function f(t, e, i) {
                    var s = e.match(t), n = e.replace(t, u);
                    if (s) for (var o, r = s.length, a = 0; a < r; a++) o = s.shift(), n = n.replace(u, i(o));
                    return n
                }
                ...
                function x(s, n) {
                    h.each(n, function (t) {
                        ...
                        var e = function (t, e) {
                            ...
                            return s
                        }(s, n[t].chunkNames), n[t].chunkNames), i = function (t, e) {
                ...
                function _(t, e, i, s, n, o) {
                    ...
                    var r, c = 0, u = 0, d = 0, a = 0, p = 0, m = 0, c = 1 - (d = 3 * e) - (u = 3 * (s - e) - d),
                        a = 1 - (m = 3 * i) - (p = 3 * (n - i) - m);
                ...
                m.shallowCopy(m.prototype.formula, {
                    ...
                    var o = m.shallowCopy({}, t), r = n || 0, n = m.composeEasingObject(t, s || "linear");
                    p.set({});
                    s = p._filterArgs;
                    ...
                    tweenCreated: function (t, e, i, s) {
                        ...
                        a = s, l = this._tokenData, h.each(l, function (t) {
                            var e = l[t].chunkNames, i = e.length, s = a[t];
                            if ("string" == typeof s) for (var n = s.split(" "), o = n[n.length - 1], r = 0; r < i; r++) a[e[r]] = n[r] || o; else for (r = 0; r < i; r++) a[e[r]] = s;
                            delete a[t]
                        ...
                        x(t, this._tokenData), x(e, this._tokenData), x(i, this._tokenData), r = s, a = this._tokenData, h.each(a, function (t) {
                            var e = a[t].chunkNames, i = e.length, s = r[e[0]];
                            if ("string" == typeof s) {
        ...
        2: [function (t, e, i) {
            var s = t("./shape"), n = t("./utils"), t = function (t, e) {
            ...
            ((t.prototype = new s).constructor = t).prototype._pathString = function (t) {
                ...
                return n.render(this._pathTemplate, {radius: e, "2radius": 2 * e})
        ...
        3: [function (t, e, i) {
            ...
            ((t.prototype = new s).constructor = t).prototype._initializeSvg = function (t, e) {
                ...
                return n.render(this._pathTemplate, {center: t.strokeWidth / 2})
            }, t.prototype._trailString = function (t) {
                return this._pathString(t)
            }, e.exports = t
        }, {"./shape": 7, "./utils": 8}],
        ...
        5: [function (t, e, i) {
            ...
            t.prototype.value = function () {
                ...
                i = l.extend(n, i);
                var o = this._easing(i.easing), n = this._resolveFromAndTo(t, o, s);
                this.stop(), this.path.getBoundingClientRect();
                var s = this._getComputedDashOffset(), t = this._progressToOffset(t), r = this;
        ...
        6: [function (t, e, i) {
            var s = t("./shape"), n = t("./circle"), o = t("./utils"), t = function (t, e) {
        ...
        7: [function (t, e, i) {
            var o = t("./path"), r = t("./utils"), s = "Object is destroyed", t = function t(e, i) {
                if (!(this instanceof t)) throw new Error("Constructor was called without new keyword");
                if (0 !== arguments.length) {
                    ...
                    var s = this._createSvgView(this._opts), n = r.isString(e) ? document.querySelector(e) : e;
            ...
            t.prototype.animate = function (t, e, i) {
                ...
                var e = this._trailString(t), t = r.extend({}, t);
        ...
        8: [function (t, e, i) {
            ...
            e.exports = {
                extend: function t(e, i, s) {
                    ...
                    return o
                }, setStyle: s, setStyles: function (i, t) {
                    n(t, function (t, e) {
                        null != t && (a(t) && !0 === t.prefix ? s(i, e, t.value) : i.style[e] = t)
                    })
                }, capitalize: o, isString: function (t) {
                    return "string" == typeof t || t instanceof String
                }, isFunction: function (t) {
                    return "function" == typeof t
                }, isObject: a, forEachObject: n, floatEquals: function (t, e) {
    ...
    var u = function (t, e) {
        var _ = Object.create(u.prototype), o = 0, T = 0, r = 0, k = 0, A = [], C = !0,
        ...
        var l = window.cancelAnimationFrame || window.mozCancelAnimationFrame || clearTimeout,
            h = window.transformProp || function () {
                ...
                if (null === t.style.transform) {
                    ...
                    for (e in i) if (void 0 !== t.style[i[e] + "Transform"]) return i[e] + "Transform"
                }
                return "transform"
            }();
        if (_.options = {
            ...
            var E, $ = function () {
                ...
                for (A = [], T = window.innerHeight, k = window.innerWidth, t = _.options.breakpoints, E = k < t[0] ? "xs" : k >= t[0] && k < t[1] ? "sm" : k >= t[1] && k < t[2] ? "md" : "lg", M(), t = 0; t < _.elems.length; t++) {
                    var e = void 0, i = _.elems[t], s = i.getAttribute("data-rellax-percentage"),
                        n = i.getAttribute("data-rellax-speed"), o = i.getAttribute("data-rellax-xs-speed"),
                        r = i.getAttribute("data-rellax-mobile-speed"), a = i.getAttribute("data-rellax-tablet-speed"),
                        ...
                        p = i.getAttribute("data-rellax-zindex") || 0, m = i.getAttribute("data-rellax-min"),
                        g = i.getAttribute("data-rellax-max"), f = i.getAttribute("data-rellax-min-x"),
                        y = i.getAttribute("data-rellax-max-x"), v = i.getAttribute("data-rellax-min-y"),
                    ...
                    var x = _.options.vertical && (s || _.options.center) ? o : 0,
                        ...
                        o = x + i.getBoundingClientRect().top, r = i.clientHeight || i.offsetHeight || i.scrollHeight,
                        a = S + i.getBoundingClientRect().left, l = i.clientWidth || i.offsetWidth || i.scrollWidth,
                        x = s || (x - o + T) / (r + T), s = s || (S - a + k) / (l + k);
                ...
                M() && !1 === C ? (O(), s = i(P)) : (s = null, window.addEventListener("resize", c), window.addEventListener("orientationchange", c), (_.options.wrapper || window).addEventListener("scroll", c, !!n && {passive: !0}), (_.options.wrapper || document).addEventListener("touchmove", c, !!n && {passive: !0}))
            }, O = function () {
                for (var t = 0; t < _.elems.length; t++) {
                    var e = A[t].verticalScrollAxis.toLowerCase(), i = A[t].horizontalScrollAxis.toLowerCase(),
                        s = -1 != e.indexOf("x") ? o : 0, e = -1 != e.indexOf("y") ? o : 0,
                        n = -1 != i.indexOf("x") ? r : 0, i = -1 != i.indexOf("y") ? r : 0;
    ...
    function i(t, e) {
        ...
        if ("object" == typeof t) this.element = t; else {
...
var scrollCue = function () {
    var o, n, r, a = {}, s = 0, l = !0, h = !0, c = !1, e = !1,
        i = {duration: 600, interval: -.7, percentage: .75, enable: !0, docSlider: !1, pageChangeReset: !1}, a = {
            setEvents: function (t) {
                ...
                if (c) for (t = docSlider.getElements().pages.length, e = 0; e < t; e++) for (i = document.querySelectorAll('[data-ds-index="' + e + '"] [data-cue]:not([data-scpage])'), s = 0; s < i.length; s++) i[s].setAttribute("data-scpage", e)
            }, sortElements: function () {
                for (var t = arguments[0], o = [].slice.call(arguments).slice(1), e = {$jscomp$loop$prop$i$4: 0}; e.$jscomp$loop$prop$i$4 < o.length; (e = {$jscomp$loop$prop$i$4: e.$jscomp$loop$prop$i$4}).$jscomp$loop$prop$i$4++) t.sort(function (n) {
                    return function (t, e) {
                ...
                for (var t = 0; t < o.length; t++) {
                    var e = o[t], i = e.group || "$" + a.getOffsetTop(e.elm);
                ...
                }, i++) if (e.$jscomp$loop$prop$elms$6 = n[t[i]], a.isElementIn(e.$jscomp$loop$prop$elms$6[0].elm)) {
...
!function (t) {
    ...
    var ShowMoreItems = window.ShowMoreItems || {}, ShowMoreItems = function (t, e) {
    ...
    ShowMoreItems.prototype.init = function (t) {
        ...
        for (var t, e = arguments[0], i = Array.prototype.slice.call(arguments, 1), s = this.length, n = 0; n < s; n++) if ("object" == typeof e || void 0 === e ? this[n].showMoreItems = new ShowMoreItems(this[n], e) : t = this[n].showMoreItems[e].apply(this[n].showMoreItems, i), void 0 !== t) return t;
        return this
    }, $(function () {
        var settings;
    ...
    var e, n, c = "createElement", v = "getElementsByTagName", b = "length", w = "style", l = "title", g = "undefined",
        x = "setAttribute", S = "getAttribute", _ = null, f = "__svgInject", T = "--inject-",
        y = new RegExp(T + "\\d+", "g"), k = "LOAD_FAIL", i = "SVG_NOT_SUPPORTED", A = "SVG_INVALID",
        u = ["src", "alt", "onload", "onerror"], C = h[c]("a"), E = typeof SVGRect != g,
    ...
    function P(t, e) {
        var i, s, n, o = T + M++, r = /url\("?#([a-zA-Z][\w:.-]*)"?\)/g, a = t.querySelectorAll("[id]"), l = e ? [] : _,
            h = {}, c = [], u = !1;
        if (a[b]) {
            ...
            for (var d, p, m, g = t[v]("*"), f = t, y = -1; f != _;) {
                ...
                })) !== p && (f.textContent = m); else if (f.hasAttributes()) {
    ...
    function O(t, e, i, s) {
        ...
        e ? (e[x]("data-inject-url", i), (n = t.parentNode) && (s.copyAttributes && function (t, e) {
            for (var i, s = t.attributes, n = 0; n < s[b]; n++) {
                var o, r, a = (r = s[n]).name;
                -1 == u.indexOf(a) && (i = r.value, a == l ? ((r = e.firstElementChild) && r.localName.toLowerCase() == l ? o = r : (o = h[c + "NS"]("http://www.w3.org/2000/svg", l), e.insertBefore(o, r)), o.textContent = i) : e[x](a, i))
            }
    ...
    var t = function t(e, i) {
        ...
        function l(o, r, t) {
            if (o) {
                var e = o[f];
                if (e) Array.isArray(e) ? e.push(t) : t(); else {
                    ...
                    var h = (C.href = e, C.href), c = r.useCache, u = r.makeIdsUnique;
                    if (c) {
                        e = function (t) {
                            var e, i, s, n;
                    ...
                    n = function (t, e) {
                        var i, s, n = t instanceof Document ? t.documentElement : z(e, !0), t = r.afterLoad;
...
var Typer = function (t) {
    var e = (this.element = t).dataset.delim || ",", i = t.dataset.words || "override these,sample typing";
...
Typer.prototype.start = function () {
    ...
    var t, e = this.element, i = this.progress, s = i.word, n = i.char, o = [...this.words[s]].slice(0, n).join(""),
