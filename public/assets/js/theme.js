!function (s) {
    ...
    var e = {
        init: () => {
            ...
            var e = s(".hamburger.animate"), a = (s(".language-select .dropdown-menu"), s(".offcanvas-nav")),
                t = s('[data-toggle="offcanvas-nav"]'), o = s(".offcanvas-nav-close"), n = s(".offcanvas-info"),
                i = s(".offcanvas-info-close"), r = s('[data-toggle="offcanvas-info"]');
            e.on("click", function () {
            ...
            s(".grid").each(function (t, e) {
                var e = s(e), a = e.find(".isotope").imagesLoaded(function () {
                    a.isotope({
                        itemSelector: ".item",
                        layoutMode: "masonry",
                        percentPosition: !0,
                        masonry: {columnWidth: a.width() / 12},
                        transitionDuration: "0.7s"
                    })
                });
                s(window).resize(function () {
                    a.isotope({masonry: {columnWidth: a.width() / 12}})
            ...
            var t = s(".navbar:not(.banner--clone)").outerHeight(), e = {"padding-top": "75px", "margin-top": "-75px"};
            ...
            SVGInject.setOptions({
                ...
                SVGInject(document.querySelectorAll("img.svg-inject"), {useCache: !0})
            })
        }, backgroundImage: () => {
            ...
            s(".hero-slider").each(function () {
                ...
                t.owlCarousel({
                    ...
                    s(".owl-item.active").find(".animated-caption").each(function (t, e) {
                        ...
                        var a = s(this).data("anim-delay"), o = s(this).data("anim-duration");
            ...
            s(".animated-captions").find(".animated-caption").each(function () {
                var t = s(this).data("anim-delay"), e = s(this).data("anim-duration");
                s(this).addClass("animate__animated").addClass(s(this).data("anim")).css({
            ...
            GLightbox({
                ...
                plyr: {
                    ...
                    config: {
                        ratio: "16:9",
                        fullscreen: {enabled: !1, iosNative: !1},
            ...
            var o = s(".progressbar.line"), n = s(".progressbar.semi-circle");
            o.each(function (t) {
            ...
            s(".progress-wrap").length && (a = document.querySelector(".progress-wrap path"), o = a.getTotalLength(), a.style.transition = a.style.WebkitTransition = "none", a.style.strokeDasharray = o + " " + o, a.style.strokeDashoffset = o, a.getBoundingClientRect(), a.style.transition = a.style.WebkitTransition = "stroke-dashoffset 10ms linear", (t = function () {
                var t = s(window).scrollTop(), e = s(document).height() - s(window).height();
            ...
            s(".counter").each(function (t, e) {
                new Waypoint({
                    element: s(this), handler: function () {
                        a(e, {duration: 1e3, delay: 50}), this.destroy()
                ...
                Array.prototype.filter.call(t, function (e) {
                    e.addEventListener("submit", function (t) {
                        !1 === e.checkValidity() && (t.preventDefault(), t.stopPropagation()), e.classList.add("was-validated"), !0 === e.checkValidity() && (t.preventDefault(), e.classList.remove("was-validated"), s.ajax({
                            ...
                            success: function (t) {
                                var e = "alert-" + t.type, a = t.message,
